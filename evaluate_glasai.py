...
TASK_NAME = "glassai_6class_segmentation"
...
def resolve_checkpoint_path(cfg, dataset_name: str):
    ...
    preferred_best = os.path.join(
        ckpt_dir,
        f"{dataset_name}_6class_best.pth",
    )

    preferred_last = os.path.join(
        ckpt_dir,
        f"{dataset_name}_6class_last.pth",
    )
...
def main():
    ...
    print("=" * 100)
    print("[INFO] Starting evaluation with GlassAI 6-class protocol")
